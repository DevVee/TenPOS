...
-- ─── Sample Products (Large Schoolbag category) ───────────────────────────────
insert into products (branch_id, category_id, name, sku, price, cost, active) values
  ...
  ('a0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000002', 'Dalmatian Medium Bag', 'MS-DAL-001', 750.00, 380.00, true),
  ('a0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000002', 'Dino Medium Bag',      'MS-DNO-001', 720.00, 360.00, true),
  ('a0000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000004', 'Unicorn Lunch Bag',    'LB-UNI-001', 350.00, 180.00, true)
