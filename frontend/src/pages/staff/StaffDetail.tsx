...
interface StaffMember {
  ...
  sales_count: number
  created_at: string
  recentActivity: { receipt_no: string; total: string; status: string; created_at: string }[]
}
...
export function StaffDetail() {
  ...
  const recentCompleted = staff.recentActivity.filter((t) => t.status === 'completed')
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="grid sm:grid-cols-2 gap-4 mb-4">
          ...
          <div className="space-y-2.5">
            {[
              ...
              ['Last Login', staff.last_login
                ? new Date(staff.last_login).toLocaleString('en-PH', { month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit' })
                : 'Never'],
            ].map(([l, v]) => (
        ...
        <div className="card p-4">
          ...
          <div className="space-y-2.5">
            {[
              ['Total Sales',     String(staff.sales_count ?? 0) + ' transactions'],
